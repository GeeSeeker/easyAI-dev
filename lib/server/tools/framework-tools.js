...
const REQUIRED_FILES = [
    ".agents/rules/always_on/project-identity.md",
    ".agents/rules/always_on/anti-hallucination.md",
    ".agents/rules/glob/coding-standards.md",
...
export function registerFrameworkCheck(server) {
    server.tool("framework_check", "检查当前项目的 easyAI 框架完整性。验证必需目录、文件、版本和 Git 状态。", {
        ...
        try {
            ...
            const latestVersion = npmLatest > FRAMEWORK_VERSION ? npmLatest : FRAMEWORK_VERSION;
            const results = {
                dirs: [],
                files: [],
                version: {
