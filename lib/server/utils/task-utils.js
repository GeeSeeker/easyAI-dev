...
const TASKS_ROOT = ".trellis/tasks";
const ARCHIVE_ROOT = ".trellis/tasks/archive";
/**
...
function getTasksDir() {
    ...
    return path.join(projectRoot, TASKS_ROOT);
}
/**
 * 获取归档目录绝对路径
 * @returns 归档目录的绝对路径
...
function getArchiveDir() {
    const projectRoot = getProjectRoot();
    return path.join(projectRoot, ARCHIVE_ROOT);
}
/**
 * 获取指定任务的目录路径
